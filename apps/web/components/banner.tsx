	...
	return (
		<div
			...
			<div className="flex items-center gap-3">
				{icon && (
					<div
						className="hidden rounded-full border border-green-600/50 bg-white/50 p-1 shadow-[inset_0_0_1px_1px_#fff] sm:block">
						{icon}
					</div>
				)}
					...
					{learnMoreUrl && (
						<>
							...
							<a
								href={learnMoreUrl}
								target="_blank"
								className="text-gray-700 underline transition-colors hover:text-black" rel="noreferrer"
							>
								Learn more
							</a>
						</>
