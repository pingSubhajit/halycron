...
export const UploadProgress = ({uploadStates, showProgress, className, onHoverChange, hasPortal = true}: Props) => {
	...
	return hasPortal ? <Portal>{ProgressContent}</Portal> : ProgressContent
}
